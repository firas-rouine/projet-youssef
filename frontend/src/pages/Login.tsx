...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const emailToUse = isAdminLogin ? "firas.firas@gmail.com" : email;
      // Mot de passe fictif pour la démo, à remplacer par un vrai système d'authentification
      const passwordToUse = isAdminLogin ? "firasF1234" : password;
              ...
              <Alert className="mb-4 bg-blue-50 border-blue-200">
                ...
                <AlertDescription className="text-blue-700">
                  ...
                  <div className="mt-2 p-2 bg-white rounded border border-blue-100">
                    <div><strong>Email:</strong> firas.firas@gmail.com</div>
                    <div><strong>Mot de passe:</strong> firasF1234</div>
                  </div>
                </AlertDescription>
              </Alert>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  value={isAdminLogin ? "firas.firas@gmail.com" : email}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    value={isAdminLogin ? "firasF1234" : password}
