...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    driverLicense: Attribute.String;
...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    carId: Attribute.Integer & Attribute.Required;
    ...
    returnLocation: Attribute.String & Attribute.Required;
    withDriver: Attribute.Boolean & Attribute.Required;
    additionalOptions: Attribute.JSON;
...
export interface ApiBookingOptionBookingOption extends Schema.CollectionType {
  collectionName: 'booking_options';
  info: {
    singularName: 'booking-option';
    pluralName: 'booking-options';
  ...
  attributes: {
    di: Attribute.String & Attribute.Required;
    name: Attribute.String & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::booking-option.booking-option',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    features: Attribute.JSON & Attribute.Required;
    available: Attribute.Boolean & Attribute.Required;
...
export interface ApiFaqFaq extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['booking', 'payment', 'cars', 'other']> &
      Attribute.Required;
    order: Attribute.Integer & Attribute.Required;
    active: Attribute.Boolean & Attribute.Required;
    createdAtt: Attribute.DateTime & Attribute.Required;
    updatedAtt: Attribute.Date & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNotificationNotification extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<
      ['bookingConfirmation', 'paymentSuccess', 'reminder', 'other']
    > &
      Attribute.Required;
    isRead: Attribute.Boolean & Attribute.Required;
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    bookingId: Attribute.Integer & Attribute.Required;
    userId: Attribute.Integer & Attribute.Required;
    amount: Attribute.Decimal & Attribute.Required;
    paymentMethod: Attribute.Enumeration<['creditCard', 'paypal', 'applePay']> &
      Attribute.Required;
    status: Attribute.Enumeration<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::booking-option.booking-option': ApiBookingOptionBookingOption;
